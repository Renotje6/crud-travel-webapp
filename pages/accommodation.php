...
<main>
    ...
    <div class="accommodation">
        <div class="accommodation-images">
            <img src="../resources/images/accommodations/1/picture1.jpg" alt="">
        </div>
        <div class="accommodation-info">
            <div class="accommodation-location">
                <h2>Lei suves</h2>
                <p>Frankrijk en stad</p>
                <p>Adres</p>
            </div>
            <div class="price">
                <h3>Vanaf Prijs</h3>
    ...
    <div class="accommodation-description">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti rerum non sed ut cupiditate adipisci et, molestias illum officia architecto culpa, est voluptatem, quasi perspiciatis ratione ad a neque exercitationem!
