...
require_once(ROOT_PATH . "/includes/controllers/registration.php");
?>
<main>
    <div class="container">
        <div class="image">
        ...
        <form id="registration-form" autocomplete="off" method="POST" action=<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>>
            ...
            <div class="floating-label">
                <input placeholder="Gebruikersnaam" type="text" name="username" id="username" autocomplete="off" <?php if (isset($values['username'])) echo 'value=' . $values['username'];
                                                                                                                    if (isset($errors['username'])) echo ' style="border-bottom: 1px red solid"' ?> require_onced>
            ...
            <div class="floating-label">
                <input placeholder="Wachtwoord" type="password" name="password" id="password" autocomplete="off" <?php
                                                                                                                    if (isset($errors['password'])) echo 'style="border-bottom: 1px red solid"' ?> require_onced>
